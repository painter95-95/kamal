...
HI.optInCookies = {
	...
	l10n: {
		agree: "Принимать",
		agreeCaption: "Да, я принимаю",
		disagree: "Нет",
		disagreeCaption: "Нет, спасибо, отвези меня в Google",
		queryBody: "Этот сайт использует файлы cookie для хранения\n информации на вашем компьютере.",
		queryTail: "Рад принять?",
		queryTitle: "Политика в отношении файлов cookie",
